 ...
 */
final class Version20230607121035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, name VARCHAR(255) NOT NULL, area INT DEFAULT NULL, created_at DATETIME NOT NULL, update_at DATETIME DEFAULT NULL, electricity VARCHAR(255) DEFAULT NULL, internet VARCHAR(255) DEFAULT NULL, sunshine_rate VARCHAR(255) DEFAULT NULL, temperature_average DOUBLE PRECISION DEFAULT NULL, cost INT DEFAULT NULL, language VARCHAR(255) DEFAULT NULL, demography INT DEFAULT NULL, housing VARCHAR(255) DEFAULT NULL, timezone INT NOT NULL, environment VARCHAR(255) DEFAULT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_2D5B0234F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
